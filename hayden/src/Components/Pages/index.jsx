  ...
  return (
    <div>
      <div className="relative w-full h-screen overflow-hidden z-[-10] bg-[#f0f0f0]">
        <img src={Hero} alt="" className="absolute top-1 left-24 w-full h-full object-contain z-[-1] scale-75" ref={fadeleft} style={{opacity: 0}}/>
      <div className='absolute top-1/2 left-30 transform -translate-y-1/2 text-left' ref={fadeup} style={{opacity: 0}}>
